...
import BACKGROUND_NIGHT_PX from './textures/background_night/px';
import BACKGROUND_NIGHT_NX from './textures/background_night/nx';
import BACKGROUND_NIGHT_PY from './textures/background_night/py';
...
import GRASS_TEXTURE from './textures/grass.dds';
...
export { BACKGROUND_DAY_NX, BACKGROUND_DAY_PX, BACKGROUND_DAY_NY, BACKGROUND_DAY_PY, BACKGROUND_DAY_NZ,
    ...
    BACKGROUND_NIGHT_NZ, BACKGROUND_NIGHT_PZ, GRASS_MATERIAL, GRASS_OBJECT, GRASS_TEXTURE, MOON, WATER_OBSTACLE_MAP };
